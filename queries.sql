...
/* queries*/
select movies.title,directors.dir_name from movies, directors where movies.dir_id=directors.dir_id;

select movies.title,movies.rel_year,directors.dir_name from movies, directors where movies.dir_id=directors.dir_id;

select directors.dir_name, movies.title from movies, directors where movies.dir_id=directors.dir_id;
